...
class SpotDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if spot == nil{ // We are adding a new record, fields should be editable
            ...
            //editable field should have border around them
            nameField.addBoarder(width: 0.5, radius: 5.0, color: .black)
            addressField.addBoarder(width: 0.5, radius: 5.0, color: .black)
        }else{
